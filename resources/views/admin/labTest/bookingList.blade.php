              ...
              <tbody>
                ...
                @foreach ($bookingList as $list)
                    <tr >
                        ...
                        <td>{{ $list->name }}</td>
                        <td>{{ $list->phone }}</td>
                        <td>{{ $list->labTest->name }}</td>
                        <td>{{ $list->amount }}</td>
                        <td>{{ $list->transaction_id }}</td>
                        <td>{{ $list->status }}</td>
                        <td>
                            <a href="{{ route('admin.lab.test.booking.view', $list->id ) }}" class="btn btn-sm btn-success mr-1"><i class="fa fa-eye"></i></a>
