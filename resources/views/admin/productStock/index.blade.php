                        ...
                        <div class="form-group">
                            ...
                            <select id="product_id" name="product_id" class="form-control select2" required>
                                ...
                                @foreach($products as $product)
                                    <option value="{{ $product->id }}" data-medicine-type="{{ $product->medicine_type }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('selling_price') is-invalid @enderror" value="{{ old('selling_price') }}" type="number" name="selling_price" placeholder="Enter Selling Price">
                                        @error('selling_price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
