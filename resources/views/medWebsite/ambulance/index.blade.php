        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ltn__breadcrumb-inner">
                    <h1 class="page-title">Ambulances</h1>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-6">
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{ asset($ambulance->image) }}" alt="{{ $ambulance->name }}" style="height: 200px; object-fit: cover;">
                                            </a>
                                            ...
                                            <div class="product-hover-action">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="{{ route('ambulance.booikng.form' , $ambulance->id) }}" title="Book Now">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="product-price">
                                                <span>৳{{ number_format($ambulance->price_per_km, 2) }}/km</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
