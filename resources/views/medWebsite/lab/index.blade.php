        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ltn__breadcrumb-inner">
                    <h1 class="page-title">Lab Test</h1>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-6">
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{ asset($labtest->image) }}" alt="{{ $labtest->name }}" style="height: 200px; object-fit: cover;">
                                            </a>
                                            <div class="product-badge">
                                                <ul>
                                                    <li class="sale-badge">{{ $labtest->status }}</li>
                                                </ul>
                                            </div>
                                            <div class="product-hover-action">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="{{ route('lab.test.services.booking.form' , $labtest->id) }}" title="Book Now">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <p class="product-title"> <strong>Hospital Name:</strong> {{  $labtest->hospital_name}}</p>
                                            <p class="product-title"> <strong>Hospital Address:</strong> {{  $labtest->hospital_address}}</p>
                                            <div class="product-price">
                                                <span>৳{{ number_format($labtest->price, 2) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
